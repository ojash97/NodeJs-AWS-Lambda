...
if (typeof window === 'undefined') {
  ...
  const { readdir, stat: fsStat } = fs.promises;
  ...
  const zipAndUpload = async (inputDirPath, inputContents, exclude, targetUploadUrl) => {
    ...
    // zip input dir
    const files = await readFiles(inputDirPath, exclude);
