...
class ServerlessSDK {
  ...
  async login(config = {}) {
    let { transactionId, loginData } = this.loginIdentity(config) // eslint-disable-line
    ...
    loginUrl = config.componentName ? `${loginUrl}/components/${config.componentName}` : loginUrl
    loginUrl = config.componentName && config.componentVersion ? `${loginUrl}/${config.componentVersion}` : loginUrl
   ...
   */
  async getUser() {
    return await resources.getUser(this)
  }
   ...
   */
  async getUserMeta() {
    return await resources.getUserMeta(this)
  }
   ...
   */
  async saveUserMeta() {
    return await resources.saveUserMeta(this)
  }
  ...
  createComponent(orgName = null, componentName = null) {
    return component.create(orgName, componentName)
  }
   ...
   * @param {*} componentDefinition An object containing the properties of a Component.
  ...
  async publishComponent(componentDefinition = {}) {
    return await component.publish(this, componentDefinition)
  }
  ...
  async getComponent(componentName = null, componentVersion = null) {
    return await component.getFromRegistry(this, componentName, componentVersion)
  }
  ...
  async getInstance(orgName = null, stageName = null, appName = null, instanceName = null) {
    return await instance.getByName(this, orgName, stageName, appName, instanceName)
  }
